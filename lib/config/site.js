...
export const SiteConfig = {
	pt: {
		name: 'Santos Advocacia — Direito Civil, Trabalhista, Empresarial e Família',
		description: 'Escritório de advocacia especializado com mais de 15 anos de experiência. Atendimento personalizado em Direito Civil, Trabalhista, Empresarial e de Família.',
		url: 'https://santosadvocacia.com.br',
		ogImage: '/og.png',
		metadataBase: '/',
		keywords: [
			'advogado',
		...
		authors: [{ name: 'Dr. Marcos Santos' }],
		creator: 'Dr. Marcos Santos',
		icons: {
			icon: '/favicon.ico',
		...
		openGraph: {
			...
			locale: 'pt_BR',
			url: 'https://santosadvocacia.com.br',
			title: 'Santos Advocacia — Defensores dos seus direitos',
			description: 'Escritório de advocacia com mais de 15 anos de experiência. Atendimento especializado em Direito Civil, Trabalhista, Empresarial e de Família.',
			siteName: 'Santos Advocacia',
		},
		twitter: {
			card: 'summary_large_image',
			title: 'Santos Advocacia',
			description: 'Assessoria jurídica especializada. Agende sua consulta.',
			images: ['/og.png'],
		},
	},
	en: {
