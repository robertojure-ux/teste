  ...
  FAQ_PT: [
    {
      ...
      answer:
        "A primeira consulta é o momento em que você apresenta sua situação ao advogado, que irá analisar os fatos, esclarecer seus direitos e indicar os caminhos jurídicos disponíveis. Ela pode ser presencial ou por videoconferência, com horário agendado previamente.",
    },
    {
      question: "Quais documentos devo levar para a consulta?",
      answer:
        "Depende da área de interesse. Em geral, recomendamos trazer: documentos pessoais (RG e CPF), contratos relacionados ao caso, notificações, comprovantes de pagamento ou qualquer documento que considere relevante. Nossa equipe orientará caso seja necessário algo específico.",
    },
    {
      question: "Quanto custa um processo judicial?",
      answer:
        "Os honorários variam conforme a complexidade do caso, a área do direito e o tempo estimado de atuação. Trabalhamos com orçamento transparente, sem taxas ocultas. Em alguns casos, é possível atuar por honorários de êxito, pagos apenas se o resultado for favorável.",
    },
    {
      question: "Quanto tempo dura um processo?",
      answer:
        "A duração depende da vara, da instância e da complexidade do caso. Processos simples podem ser resolvidos em meses, enquanto casos mais complexos podem levar anos. Mantemos nossos clientes informados em todas as fases, com atualizações regulares.",
    },
    {
      question: "Vocês atendem todo o Brasil?",
      answer:
        "Sim. Realizamos consultas por videoconferência para clientes de qualquer estado. Para processos em outras comarcas, contamos com uma rede de advogados correspondentes parceiros em todo o território nacional.",
    },
    {
      question: "O que é honorário de êxito?",
      answer:
        "Honorário de êxito é uma modalidade em que o cliente paga os honorários advocatícios apenas se o resultado for favorável. Esse modelo é comum em ações trabalhistas, cíveis e de indenização, e demonstra o comprometimento do advogado com o sucesso do seu caso.",
    },
    {
      question: "É possível resolver questões jurídicas sem ir ao tribunal?",
      answer:
        "Sim. Muitos conflitos são resolvidos por meio de negociação, mediação ou conciliação, sem necessidade de ação judicial. Buscamos sempre a solução mais eficiente e menos onerosa para o cliente, priorizando acordos extrajudiciais quando possível.",
    },
    {
      question: "Como funciona o atendimento por videoconferência?",
      answer:
        "O atendimento online é realizado por plataformas seguras como Google Meet ou Zoom. O cliente agenda o horário, recebe o link de acesso e pode participar da consulta de qualquer lugar, com a mesma qualidade do atendimento presencial.",
    },
  ],
  FAQ_EN: [
    {
